...
import {
  ...
  School, AlertTriangle, Eye, Loader2, Layers, Database, HelpCircle
} from "lucide-react";
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="shrink-0 ml-auto">
                {!state.loaded ? (
                  ...
                  <Button
                    variant="ghost"
                    className="h-7 px-2 text-[9px] uppercase font-bold text-muted-foreground hover:text-foreground shrink-0"
