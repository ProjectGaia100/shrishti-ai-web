...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("group/calendar bg-background p-3 [--cell-size:2.25rem]", className)}
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative rounded-md border border-input shadow-sm focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/50",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-2 group-data-[focused=true]/day:ring-ring/50",
