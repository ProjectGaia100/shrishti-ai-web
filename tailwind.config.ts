  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        dataset: {
          vegetation: "hsl(var(--dataset-vegetation))",
          terrain: "hsl(var(--dataset-terrain))",
          lights: "hsl(var(--dataset-lights))",
          landcover: "hsl(var(--dataset-landcover))",
          temperature: "hsl(var(--dataset-temperature))",
        },
